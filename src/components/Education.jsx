...
const Education = () => {
  return (
    <div id="education" className="relative w-full py-12">
      <img className="absolute orbital" src={orbitalImg} alt="" />
      <div className="container relative px-4 mx-auto text-center">
        ...
        <motion.div
          ...
          className="w-full max-w-4xl p-6 mx-auto text-gray-400 shadow-md bg-[#1e2133] rounded-md shadow-[#303e66] bg-opacity-70"
        >
