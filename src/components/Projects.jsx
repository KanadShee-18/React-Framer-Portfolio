      ...
      <div>
        {PROJECTS.map((project, index) => (
          <div key={index} className="mb-12 flex flex-wrap lg:justify-center">
            ...
            >
              <h6 className="mb-2 font-semibold text-2xl bg-gradient-to-r from-pink-400 via-slate-500 to-purple-500 bg-clip-text tracking-tight text-transparent cursor-pointer hover:bg-gradient-to-r hover:from-purple-400 hover:via-slate-500 hover:to-pink-500 hover:bg-clip-text hover:tracking-tight hover:text-transparent">
                {project.title}
              </h6>
